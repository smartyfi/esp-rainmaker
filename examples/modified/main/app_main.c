...
void app_main()
{
    ...
    esp_log_level_set("esp_mqtt_glue",ESP_LOG_VERBOSE);
    esp_log_level_set("SSL TLS",ESP_LOG_INFO);
    esp_log_level_set("OUTBOX",ESP_LOG_INFO);
    esp_log_level_set("event",ESP_LOG_VERBOSE);
    esp_log_level_set("esp_rmaker_node_config",ESP_LOG_VERBOSE);
    esp_log_level_set("esp_rmaker_local",ESP_LOG_VERBOSE);
    esp_log_level_set("esp_rmaker_param",ESP_LOG_VERBOSE);

    esp_log_level_set("esp_rmaker_device",ESP_LOG_VERBOSE);
    esp_log_level_set("esp_claim",ESP_LOG_VERBOSE);
    esp_log_level_set("esp_rmaker_node",ESP_LOG_VERBOSE);
    esp_log_level_set("esp_rmaker_user_mapping",ESP_LOG_VERBOSE);
    esp_log_level_set("esp_rmaker_mqtt",ESP_LOG_VERBOSE);
    esp_log_level_set("esp_rmaker_ota_using_topics",ESP_LOG_VERBOSE);
    esp_log_level_set("esp_rmaker_ota_using_params",ESP_LOG_VERBOSE);
    ...
    // err = nvs_flash_init();
    // ESP_ERROR_CHECK( err );
    //ESP_ERROR_CHECK(nvs_flash_erase_partition(CONFIG_ESP_RMAKER_FACTORY_PARTITION_NAME));
